...
OLD_CYC, NEW_CYC = '14966.0', '15054.0'
...
lvb_anchor = "  { key:'THE ONLY PLAYER ADMIN', col:'#ff8c42',"
...
COLHEX = {693:'#f2c14e', 694:'#5cc8ff', 695:'#c2e86a', 696:'#ff9ec4'}
rows = []
for b in BEATS:
...
seg_anchor = "  if(c >= 14944.0 && c < 14966.0) return [692, c-14944.0];"
