...
OLD_CYC, NEW_CYC = '15054.0', '15076.0'
...
lvb_anchor = "  { key:'NOW IT IS MY TURN', col:'#ff9ec4',"
...
seg_anchor = "  if(c >= 15032.0 && c < 15054.0) return [696, c-15032.0];  // NOW IT IS MY TURN"
